...
class WGraph_AlgoTest {
    ...
    @Test
    void isConnected() {
        weighted_graph g0 = WGraph_DSMyTest.graph_creator(0,0,1);
        weighted_graph_algorithms ag0 = new WGraph_Algo();
        ag0.init(g0);
        boolean flag = ag0.isConnected();
        assertTrue(ag0.isConnected());
  
        g0 = WGraph_DSMyTest.graph_creator(1,0,1);
        ag0 = new WGraph_Algo();
        ag0.init(g0);
        flag = ag0.isConnected();
        assertTrue(ag0.isConnected());

        g0 = WGraph_DSMyTest.graph_creator(2,0,1);
        ag0 = new WGraph_Algo();
        ag0.init(g0);
        flag = ag0.isConnected();
        assertFalse(ag0.isConnected());
        
         g0 = WGraph_DSMyTest.graph_creator(2,1,1);
        ag0 = new WGraph_Algo();
        ag0.init(g0);
        flag = ag0.isConnected();
        assertTrue(ag0.isConnected());

        g0 = WGraph_DSMyTest.graph_creator(10,30,1);
        ag0.init(g0);
    ...
    @Test
    void save_load() {
        weighted_graph g0 = WGraph_DSMyTest.graph_creator(10,30,1);
        weighted_graph_algorithms ag0 = new WGraph_Algo();
        ag0.init(g0);
        String str = "g0.obj";
        ag0.save(str);
    ...
    private weighted_graph small_graph() {
        weighted_graph g0 = WGraph_DSMyTest.graph_creator(11,0,1);
        g0.connect(0,1,1);
        g0.connect(0,2,2);
        g0.connect(0,3,3);
